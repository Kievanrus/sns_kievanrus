...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US">
	<head>
		...
		<script defer type="text/javascript">
			var site_url = 'http://kievanrus.ru/';
        ...
        <div class="adm-header">
        	<div class="adm-header-content">
            	<div class="adm-header-title bx-def-margin-sec-left">
                    ...
                    <img class="adm-header-logo" src="http://kievanrus.ru/administration/templates/base/images/logo.png" />
                    ...
                    <!--
                        $(document).ready(function() {
                            $.get(
                                'http://kievanrus.ru/get_rss_feed.php?ID=boonex_version&member=0', 
                                {},
                                function(sData) {
                                	if(!sData)
                                	    return;
                                    ...
                                    if(sVerNew != undefined && sVerNew != null && sVerNew != '' && sVerNew != sVerCur)
                                        $('#adm-header-update').html('<a href="http://www.boonex.com/dolphin/download/">Обновить до ' + sVerNew + ' сейчас!</a>');
                                },
                                'text'
                            );
                        });
