                                                            ...
                                                            <table cellpadding="0" cellspacing="0">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="reduce"><div><i class="sys-icon remove" alt="минимизировать"  title="минимизировать" width="14" height="14" border="0" onclick="membermenu.close_popup('extra_menu_popup_<?=$a['bx_repeat:items'][$i]['bx_if:sub_menu']['content']['bx_if:reduce_element_top']['content']['menu_id'];?>')"></i></div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        ...
                                                        <div class="extra_data <?=$a['bx_repeat:items'][$i]['bx_if:sub_menu']['content']['bx_if:reduce_element_bottom']['content']['cover'];?>"><table cellpadding="0" cellspacing="0">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="reduce"><div><i class="sys-icon remove" alt="минимизировать"  title="минимизировать" width="14" height="14" border="0" onclick="membermenu.close_popup('extra_menu_popup_<?=$a['bx_repeat:items'][$i]['bx_if:sub_menu']['content']['bx_if:reduce_element_bottom']['content']['menu_id'];?>')"></i></div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        ...
                                                        <div class="extra_data <?=$a['bx_repeat:extra_items'][$i]['bx_if:sub_menu']['content']['bx_if:reduce_element_top']['content']['cover'];?>">
                                                            <table cellpadding="0" cellspacing="0"><tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="reduce"><i class="sys-icon remove" alt="минимизировать"  title="минимизировать" width="14" height="14" border="0" onclick="membermenu.close_popup('extra_menu_popup_<?=$a['bx_repeat:extra_items'][$i]['bx_if:sub_menu']['content']['bx_if:reduce_element_top']['content']['menu_id'];?>')"></i></td>
                                                                </tr>
                                                            </tbody>
                                                            </table>
                                                        </div>
                                                        ...
                                                        <div class="extra_data <?=$a['bx_repeat:extra_items'][$i]['bx_if:sub_menu']['content']['bx_if:reduce_element_bottom']['content']['cover'];?>">
                                                            <table cellpadding="0" cellspacing="0"><tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="reduce"><i class="sys-icon remove" alt="минимизировать"  title="минимизировать" width="14" height="14" border="0" onclick="membermenu.close_popup('extra_menu_popup_<?=$a['bx_repeat:extra_items'][$i]['bx_if:sub_menu']['content']['bx_if:reduce_element_bottom']['content']['menu_id'];?>')"></i></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
...
<script type="text/javascript">
    ...
    var membermenu = 
    {
        ...
        page_url            : 'http://kievanrus.ru/<?=$a['page_reciver'];?>',
